...
const Home = () => {
  ...
  return (
    <div className="">
      <div
        id="first-section"
        className="w-full py-12 pt-10 px-12 NotLaptop:w-[60%] NotLaptop:translate-x-[-50%] NotLaptop:relative NotLaptop:left-1/2"
      >
          ...
          <div className="flex flex-col gap-7 NotLaptop:items-center">
            ...
            >
              <input
                ...
                className="w-full bg-[#F7F7F71A] border border-[#A3A3A3] rounded-tl-xl rounded-bl-xl LaptopButINB:rounded-bl-[10px] LaptopButINB:rounded-tl-[10px] outline-0 p-[12px] LaptopButINB:p-[10px] placeholder:text-[#B8B8B8]"
              />
              <button
                type="submit"
                className="w-full bg-ButtonBgColor h-full text-white rounded-tr-xl rounded-br-xl LaptopButINB:rounded-br-[10px] LaptopButINB:rounded-tr-[10px] p-[12px]"
              >
                Search
              </button>
            </form>
      ...
      >
        <h1 className="text-[40px] font-bold NotLaptop:text-[34px]">
          Inspiration for your next adventure
        </h1>
        <div className="grid grid-cols-4 gap-6 NotLaptop:grid-cols-2">
          {NFTData.map((item) => (
      ...
      <div
        id="forth-section"
        className="w-full bg-ButtonBgColor grid p-20 NotLaptop:px-32 items-center mt-2 NotLaptop:gap-16"
      ...
      >
        ...
        <div className="w-full flex items-center justify-center NotLaptop:row-start-1">
          ...
          <figure className="w-[500px] NotLaptop:w-[400px]">
